...
describe('Parser', () => {
  ...
  describe('parse', () => {
    ...
    const map = {
      ...
      '10/3a Đỗ Ngọc Thạnh, Hồ Chí Minh, Việt Nam':
        ['Thành phố Hồ Chí Minh'],
      ...
      '533/15 Nguyễn Tri Phương P8 Q10':
        ['Phường 8', 'Quận 10', 'Thành phố Hồ Chí Minh'],
      'Phú Mỹ Hưng, Q7, TP. HCM':
        ['Quận 7', 'Thành phố Hồ Chí Minh'],
      'phuongxuanhieu@gmail.com':
        [],
      'Phòng Đào tạo - ĐH Nông Lâm Thái Nguyên':
        ['Tỉnh Thái Nguyên'],
      ...
      'Thành phố Hồ Chí Minh, Hồ Chí Minh, Việt Nam':
        ['Thành phố Hồ Chí Minh'],
      '81 Nguyen Chi Thanh, Da Nang, Vietnam':
        ['Thành phố Đà Nẵng'],
      '212 Nguyễn Trãi, Ho Chi Minh City, Vietnam':
        ['Thành phố Hồ Chí Minh'],
      'Định Công':
        [],
      ...
      '204 Hồ Tùng Mậu, Cầu Diễn, Cầu Giấy, Hà Nội 100000':
        ['Phường Cầu Diễn', 'Quận Cầu Giấy', 'Thành phố Hà Nội'],
      ...
      'P202, 2 Núi Trúc, Ba Đình, Hà Nội':
        ['Quận Ba Đình', 'Thành phố Hà Nội'],
